...
def run_simulation():
    ...
    for d in range(N_DEALS):
        ...
        unresolved_counts.append(unresolved_count(self_faces))
        unresolved_counts.append(unresolved_count(opp_faces))
    ...
    return payoff, bet_t_records, unresolved_counts
...
def main():
    ...
    payoff, bet_t_records, unresolved_counts = run_simulation()
    ...
    with open("/home/user/original/sim/mold_dice_timing_market/k1_results.json", "w", encoding="utf-8") as f:
